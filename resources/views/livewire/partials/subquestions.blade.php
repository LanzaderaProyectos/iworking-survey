...
<div id="collapseSubQuestionsCreate" class="collapse show col-12 card-body" aria-labelledby="headingTwo"
    ...
    {{-- <div class="col-md-4 col-12 mt-3">
        <div class="form-group ">
            ...
            <div class="d-flex">
                ...
                <button wire:click="addDefaultQuestionSub()" class="btn btn-dark" type="button"
                    title="Añadir">+</button>
            </div>
                ...
                {{-- <nav id="create-questions">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-subquestion-tab" data-toggle="tab"
                            href="#nav-subquestion-es" role="tab" aria-controls="nav-home"
                            aria-selected="true">Español</a>
                        <a class="nav-item nav-link" id="nav-subquestion-tab" data-toggle="tab"
                            href="#nav-subquestion-en" role="tab" aria-controls="nav-profile"
                            aria-selected="false">Ingles</a>
                    </div>
                </nav> --}}
...
<div id="collapseSubQuestions" class="collapse show col-12 card-body" aria-labelledby="headingTwo"
    data-parent="#accordion" wire:ignore.self>
    <div class="row">
        <div class="col-12">
            <table class="table table-striped table-bordered table-hover table-checkable">
                ...
                <tbody>
                    @foreach($this->survey->sections()->find($sectionQuestionSelected)->surveyQuestionsSubIgnoreDisabled->sortBy('position')
                    as $item)
                    <tr>
                        <td nowrap>
                            @if($this->formEdit)
                            ...
                            <button wire:loading.attr="disabled" wire:click="upSubQuestion('{{ $item->id }}')"
