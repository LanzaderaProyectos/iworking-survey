                ...
                <div class="form-group">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-subquestion-en" role="tabpanel"
                            ...
                            <input {{ $this->formEdit ? '' : 'disabled' }} wire:model="subQuestionName.en"
            ...
            <div class="col-md-5 col-12">
                <div class="form-group mb-3">
                    ...
                    <select {{ $this->formEdit ? '' : 'disabled' }} wire:model.live="subTypeSelected"
                        class="form-control " id="numbers_format_input" size="2">
...
<div class="row">
    <div class="col-12">
        <table class="table table-striped table-bordered table-hover table-checkable">
            ...
            <tbody>
                @foreach ($this->survey->subQuestions as $item)
                    <tr>
                        <td nowrap>
